...
public class TypeMarketPlaceController implements RestControllerInterface<TypeMarketPlace, Object> {
    ...
    @PostMapping
    @Override
    public ResponseEntity<ApiResponse<TypeMarketPlace>> create(@RequestBody TypeMarketPlace model) {
        return res.returnResponseJson(SuccessCode.CREATE_SUCCESS, typeMarketPlaceService.create(model));
    }
    ...
    @PutMapping("/{id}")
    @Override
    public ResponseEntity<ApiResponse<TypeMarketPlace>> update(@PathVariable Integer id, @RequestBody TypeMarketPlace model) {
       return res.returnResponseJson(SuccessCode.UPDATE_SUCCESS, typeMarketPlaceService.update(id,model));
    }
}
